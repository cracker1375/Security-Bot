    ...
    if msgs > max_msg then
      ...
      if gbanspamonredis then
        if tonumber(gbanspamonredis) ==  7 and not is_owner(msg) then
          ...
          send_large_msg("chat#id"..msg.to.id, "》کاربر [ "..name.." ]"..msg.from.id.." از تمامی گروه های ربات مسدود شد(به دلیل ارسال پیام مکرر)")
		  send_large_msg("channel#id"..msg.to.id, "》کاربر [ "..name.." ] با شناسه کاربری ["..msg.from.id.."] از تمامی گروه های ربات مسدود شد(به دلیل ارسال پیام مکرر)")
